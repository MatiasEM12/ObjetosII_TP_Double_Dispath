...
public class Juego {
    ...
    public void iniciar() {
        ...
        while (continuar) {
            ...
            System.out.println(new Jugada().jugar(elementoJuego(eleccionUsuario), elementoJuego(eleccionComputadora)));
    ...
    private ElementoJuego elementoJuego(String elemento){
        switch (elemento) {
            case "piedra":
                return new Piedra();
            case "papel":
            ...
            case "tijera":
                return new Tijera();
            default:
                throw new IllegalArgumentException("Opción no válida: " + elemento);
        }
    }
}
